...
R_cov = diag([2e-1, 3e-1, 1e3,...
              1e3, 1e-4, 5e-4,...
              1e-7, 1e-7]); % Sensor noise Covariance Matrix
Q_cov = diag([0, 1e-5, 1.5e-5, 1]); % Processor noise Covariance Matrix
...
subplot(2, 4, 1);
hold on;
plot(timeStamp, acc_x_imu, 'r', 'DisplayName', 'acc_x'); 
plot(timeStamp, h_obs(1,:), 'g', 'DisplayName', 'acc_x_{obs}'); 
...
subplot(2, 4, 2);
hold on;
plot(timeStamp, acc_y_imu, 'r', 'DisplayName', 'acc_y');
plot(timeStamp, h_obs(2,:), 'g', 'DisplayName', 'acc_y_{obs}'); 
title('IMU Acceleration');
xlabel('TimeStamp');
ylabel('m/s^2');
xlim(x_lim);
...
subplot(2, 4, 3);
hold on;
plot(timeStamp, acc_z_imu, 'r', 'DisplayName', 'acc_z');
plot(timeStamp, h_obs(3,:), 'g', 'DisplayName', 'acc_z_{obs}'); 
title('IMU Acceleration');
xlabel('TimeStamp');
ylabel('m/s^2');
xlim(x_lim);
...
subplot(2, 4, 5);
hold on;
plot(timeStamp, rad2deg(gyr_x_imu), 'r', 'DisplayName', 'gyr_x'); 
plot(timeStamp, rad2deg(h_obs(4,:)), 'g', 'DisplayName', 'gyr_x_{obs}'); 
...
subplot(2, 4, 6);
hold on;
plot(timeStamp, rad2deg(gyr_y_imu), 'r', 'DisplayName', 'gyr_y');
plot(timeStamp, rad2deg(h_obs(5,:)), 'g', 'DisplayName', 'gyr_y_{obs}'); 
title('IMU Angular Velocity');
xlabel('TimeStamp');
ylabel('deg/s');
xlim(x_lim);
...
subplot(2, 4, 7);
hold on;
plot(timeStamp, rad2deg(gyr_z_imu), 'r', 'DisplayName', 'gyr_z');
plot(timeStamp, rad2deg(h_obs(6,:)), 'g', 'DisplayName', 'gyr_z_{obs}'); 
title('IMU Angular Velocity');
xlabel('TimeStamp');
ylabel('deg/s');
xlim(x_lim);
...
plot(timeStamp, rad2deg(h_obs(7,:)), 'g', 'DisplayName', 'd\theta_{RW}_{obs}'); 
...
plot(timeStamp, rad2deg(h_obs(8,:)), 'g', 'DisplayName', 'd\theta_{LW}_{obs}'); 
